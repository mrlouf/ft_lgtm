...
- Discuss architecture and design decisions: I used ChatGPT to confront my ideas and discuss architecture and design decisions, from the backend API to the cluster architecture and Helm installation.
